...
public class Menu extends javax.swing.JPanel {
    ...
    private void initMenu() {
        addMenu("Accueil", "1", 0);
        addMenu("Gestion des patients", "2", 1);
        addMenu("Consultations", "3", 2);
        addMenu("Analyses", "4", 3);
        addMenu("Rendez-vos", "5", 4);
        addMenu("Medicaments", "6", 5);
        addMenu("Parametres", "7", 6);
        addMenu("Mes Medecins", "2", 7);
        addMenu("Mes Infirmiers", "2", 8);
        addMenu("Mes Secretaires", "2", 9);
        addMenu("Utlisateurs", "2", 10);
         addMenu("Deconnexion", "8", 11);
        //  add more menu here
        menu.repaint();
        menu.revalidate();
        setSelectedMenu(0);
