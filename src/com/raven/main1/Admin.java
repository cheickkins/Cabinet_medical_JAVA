package com.raven.main1;

import com.raven.event.EventColorChange;
import com.raven.form.FrameConnexion;
import com.raven.form.Home_Form;
import com.raven.form.PanelAnalyse;
import com.raven.form.PanelConsultation;
import com.raven.form.PanelInfirmier;
import com.raven.form.PanelMedecin;

import com.raven.form.PanelMedicaments;
import com.raven.form.PanelPatient;
import com.raven.form.PanelRdv;
import com.raven.form.PanelSecretaire;
import com.raven.form.PanelUtilisateur;
import com.raven.form.Setting_Form;
import com.raven.menu1.EventMenu;
...
public class Admin extends javax.swing.JFrame {
        ...
        menu.addEventMenu(new EventMenu() {
            ...
            public void selectedMenu(int index) {
                if (index == 0) {
                    ...
                    mainBody.displayForm(new PanelPatient(), "Gestion des patients");
                }
                else if (index == 2) {
                    mainBody.displayForm(new PanelConsultation(), "Gestion des Consultations");
                }
                 else if (index == 3) {
                    mainBody.displayForm(new PanelAnalyse(), "Gestion des Analyses");
                }
                else if (index == 4) {
                    mainBody.displayForm(new PanelRdv(), "Gestion des Rendez-Vous");
                }
                 else if (index == 5) {
                    mainBody.displayForm(new PanelMedicaments(), "Gestion des Medicaments");
                 }
                else if (index == 6) {
                    ...
                    mainBody.displayForm(new PanelMedecin(), "MEDECINS");
            }
                else if (index == 8) {
                    mainBody.displayForm(new PanelInfirmier(), "Gestion des infirmiers");
            }
                  else if (index == 9) {
                    mainBody.displayForm(new PanelSecretaire(), "Gestion des Secretaires");
            }
                 else if (index == 10) {
                    mainBody.displayForm(new PanelUtilisateur(), "Gestion des Utilisateurs");
            }
                  else if (index == 11) {
    ...
    private com.raven.menu1.Menu menu;
