...
public class Setting_Form extends Form {
    ...
    private void initComponents() {
        ...
        lbDark.setText("Mode sombre");

        jLabel2.setForeground(new java.awt.Color(128, 128, 128));
        jLabel2.setText("Utilisez le mode sombre ou clair selon la compatibilité de votre font");
        ...
        lbColor.setText("Theme Couleur");

        jLabel4.setForeground(new java.awt.Color(128, 128, 128));
        jLabel4.setText("Selectionnez une couleur pour votre theme");
